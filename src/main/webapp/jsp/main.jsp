    ...
    <div class="container-fluid">
        ...
        <div>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a>欢迎:${sessionScope.currentAdmin.username}</a></li>
                ...
                <div id="myCarousel" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="${path}/img/1.jpg" alt="First slide">
                            <div class="carousel-caption">哇卡卡 1</div>
                        </div>
                        <div class="item">
                            <img src="${path}/img/2.jpg" alt="Second slide">
                            <div class="carousel-caption">呦吼 2</div>
                        </div>
                        <div class="item">
                            <img src="${path}/img/3.jpg" alt="Third slide">
                            <div class="carousel-caption">哒哒哒 3</div>
                        </div>
                    </div>
                    <!-- 轮播（Carousel）导航 -->
